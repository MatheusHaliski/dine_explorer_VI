    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col h-[600px] bg-white/45 fe-glass-panel border-8 rounded-2xl border-orange-300 items-center">
                <form className="-translate-x-10 space-y-8 text-base mt-20 fe-glass-panel rounded-2xl border border-yellow/200 p-20 sm:margin-bottom-20" onSubmit={handleSubmit}>
